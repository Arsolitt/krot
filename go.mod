module github.com/Arsolitt/krot

go 1.26.4

require (
	github.com/Arsolitt/cheburbox v0.2.1
...
require (
	...
	github.com/Arsolitt/amnezigo v0.2.0 // indirect
	...
	github.com/sagernet/sing-box v1.13.14-extended-2.5.0 // indirect
